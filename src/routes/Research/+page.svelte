...
<div class="container mx-auto flex flex-col lg:flex-row">
    ...
    <div use:onLoad id="content-area" class="w-full lg:w-auto lg:ml-[15%]
        ...
        <div id="publications_academic" class="section">
            ...
            <Card
                publisher="MA Thesis"
                title="De Re <P Italic>Beliefs and Evidence in Legal Cases</P>"
        ...
        <div id="publications_public" class="section">
            ...
            <Card
                publisher="<P italic>Margin Notes</P>"
            ...
            />
            <Card
                publisher="<P Italic>Cosmonaut Mag</P>"
            ...
            />
            <Card
                publisher="<P Italic>Diginativ</P>"
